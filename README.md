...
Only Docker is required for Linux, Windows, the web player, Android, Nintendo Switch, and Sega Dreamcast (no local compiler or CMake):
...
See [BUILDING.md](BUILDING.md) for Windows, wasm, WASI, Android, Switch, Dreamcast, macOS, and native CMake.
