...
if (PLATFORM_VITA OR VITA)
  ...
  set (SDL_HIDAPI OFF CACHE BOOL "" FORCE)
  set (SDL_VIRTUAL_JOYSTICK OFF CACHE BOOL "" FORCE)
  # try_compile is STATIC_LIBRARY; _GNU_SOURCE makes newlib declare sigaction
  # in sys/signal.h, but vitasdk libc has no sigaction (SDL_quit.c then fails
  # at link). Keep HAVE_SIGNAL_H so SDL falls back to signal().
