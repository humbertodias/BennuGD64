...
elseif (CMAKE_SYSTEM_NAME STREQUAL "tvOS")
  ...
  set (BENNUGD_PACKAGE_NOTE "Open bgdi.app in Xcode/Simulator, or install on Apple TV. Put main.dcb in tvos/contents/ (copied to the .app root); Documents via SDL_GetPrefPath overrides it.")
elseif (CMAKE_SYSTEM_NAME STREQUAL "iOS")
  set (BENNUGD_PACKAGE_LINKAGE "static")
  set (BENNUGD_PACKAGE_MODULES_NOTE "linked into bgdi.app")
  set (BENNUGD_PACKAGE_DEPS "zlib, libpng, SDL3 (Metal), SDL3_mixer (stb_vorbis + dr_mp3), bundled DES, iOS SDK")
  set (BENNUGD_PACKAGE_NOTE "Open bgdi.app in Xcode/Simulator, or install on an iPhone/iPad. Put main.dcb in ios/contents/ (copied to the .app root); Documents via Finder overrides it.")
elseif (PLATFORM_PS2 OR PS2)
  set (BENNUGD_PACKAGE_LINKAGE "static")
