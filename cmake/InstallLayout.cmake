...
elseif (CMAKE_SYSTEM_NAME STREQUAL "tvOS")
  ...
  if (CMAKE_OSX_SYSROOT MATCHES "[Ss]imulator")
    set (BENNUGD_PACKAGE_NOTE "On a Mac run ./sim-install.sh (chmod +x and ad-hoc codesign), then install with simctl. Put main.dcb in tvos/contents/ (copied to the .app root); Documents via SDL_GetPrefPath overrides it.")
  else ()
    set (BENNUGD_PACKAGE_NOTE "Unsigned bgdi.app from Docker/osxcross. Sign on a Mac before a device. Put main.dcb in tvos/contents/ (copied to the .app root); Documents via SDL_GetPrefPath overrides it.")
  endif ()
elseif (CMAKE_SYSTEM_NAME STREQUAL "iOS")
  set (BENNUGD_PACKAGE_LINKAGE "static")
  set (BENNUGD_PACKAGE_MODULES_NOTE "linked into bgdi.app")
  ...
  if (CMAKE_OSX_SYSROOT MATCHES "[Ss]imulator")
    set (BENNUGD_PACKAGE_NOTE "On a Mac run ./sim-install.sh (chmod +x and ad-hoc codesign), then install with simctl. Put main.dcb in ios/contents/ (copied to the .app root); Documents via Finder overrides it.")
  else ()
    set (BENNUGD_PACKAGE_NOTE "Unsigned bgdi.app from Docker/osxcross. Sign on a Mac before a device. Put main.dcb in ios/contents/ (copied to the .app root); Documents via Finder overrides it.")
  endif ()
elseif (PLATFORM_PS2 OR PS2)
  set (BENNUGD_PACKAGE_LINKAGE "static")
