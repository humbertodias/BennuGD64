...
#include <kernel.h>
#endif
#if defined(TARGET_PS2) || defined(TARGET_PSP) || defined(__linux__)
#include <malloc.h>
...
static const uint8_t glyph_bits[][7] = {
    ...
    { 0x1f, 0x11, 0x11, 0x1f, 0x11, 0x11, 0x11 }, /* P */
    { 0x0f, 0x10, 0x10, 0x0f, 0x01, 0x01, 0x1e }, /* S */
    { 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x1f }, /* M */
