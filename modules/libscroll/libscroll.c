...
void scroll_update( int n )
{
    ...
    if ( scrolls[n].camera )
    {
        ...
        /* Forzar a que estù en el centro de la ventana */
    ...
    /* Scrolls no cùclicos y posiciùn del background */
    ...
    /* Actualiza la posiciùn del scroll segùn las variables globales */
